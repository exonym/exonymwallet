...
public class VerifierModule extends ZkModuleImpl implements ZkModuleVerifier {
  ...
  private final @Nullable BigInt value;

  public VerifierModule(final ConstantBuildingBlock parent, final String identifierOfModule, final String attributeId,
                        final @Nullable BigInt value) {
  ...
  public void collectAttributesForVerify(final ZkVerifierStateCollect zkVerifier) throws ProofException {
    ...
    zkVerifier.setResidueClass(attributeId, ResidueClass.INTEGER_IN_RANGE);
  }
