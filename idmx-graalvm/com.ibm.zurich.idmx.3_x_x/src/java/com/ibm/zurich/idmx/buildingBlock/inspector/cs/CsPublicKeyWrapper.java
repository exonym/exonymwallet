...
public class CsPublicKeyWrapper extends InspectorPublicKeyWrapper {
  ...
  public CsPublicKeyWrapper(final PublicKey publicKey) {
    super(publicKey);
  }
  ...
  public void setHashFunction(final String hashFunctionName) {
    String hashFunctionUri = AbcUriConfigurator.prependBasicUri(hashFunctionName);
  ...
  private BigInt getY(final int i) throws ConfigurationException {
