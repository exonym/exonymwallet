...
public class StateStoragePersistentRecipient extends StateStoragePersistent<StateRecipient>{

  @Inject
  public StateStoragePersistentRecipient(PersistentStorage ps) {
    super(ps, SimpleParamTypes.STATE_RECIPIENT);
  }
