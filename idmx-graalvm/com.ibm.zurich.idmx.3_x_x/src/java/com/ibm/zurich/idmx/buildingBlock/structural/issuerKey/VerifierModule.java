...
public class VerifierModule extends ZkModuleImpl implements ZkModuleVerifier {
  ...
  public VerifierModule(final IssuerPublicKeyBuildingBlock parent, final String identifierOfModule,
  ...
  public boolean verify(final ZkVerifierStateVerify zkVerifier) throws ConfigurationException,
      ProofException {
    zkVerifier.checkNValue(getIdentifier() + ":publicKey:c14n", pk.getHash(sp.getHashFunction()));
    return true;
  }
