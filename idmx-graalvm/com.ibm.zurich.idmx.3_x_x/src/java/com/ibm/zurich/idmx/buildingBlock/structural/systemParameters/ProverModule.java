...
public class ProverModule extends ZkModuleImpl implements ZkModuleProver {
  ...
  public ProverModule(final SystemParametersBuildingBlock parent, final String identifierOfModule,
  ...
  public void firstRound(final ZkProofStateFirstRound zkBuilder) throws ConfigurationException {
    zkBuilder.addNValue(getIdentifier() + ":systemParameters:c14n",
        sp.getHash(sp.getHashFunction()));
  }
