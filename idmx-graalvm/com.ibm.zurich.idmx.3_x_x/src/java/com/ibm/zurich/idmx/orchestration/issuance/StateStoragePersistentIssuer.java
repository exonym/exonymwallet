...
public class StateStoragePersistentIssuer extends StateStoragePersistent<StateIssuer>{

  @Inject
  public StateStoragePersistentIssuer(PersistentStorage ps) {
    super(ps, SimpleParamTypes.STATE_ISSUER);
  }
