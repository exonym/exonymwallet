...
public class SignedQuadraticResiduesGroupMOS
    extends
  ...
  public SignedQuadraticResiduesGroupMOS(final HiddenOrderGroup group,
		  final BigIntFactory bigIntFactory) {
    this.group = (SignedQuadraticResiduesGroupImpl) group;
