...
public class VerifierModule extends ZkModuleImpl implements ZkModuleVerifier {
  ...
  public VerifierModule(final MechanismSpecificationBuildingBlock parent, final String identifierOfModule,
  ...
  public boolean verify(final ZkVerifierStateVerify zkVerifier) throws ConfigurationException,
      ProofException {
    zkVerifier.checkNValue(getIdentifier() + ":mechanismSpecification:c14n",
