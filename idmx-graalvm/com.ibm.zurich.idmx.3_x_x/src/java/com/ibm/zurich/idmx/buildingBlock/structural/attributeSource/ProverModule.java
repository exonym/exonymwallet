...
public class ProverModule extends ZkModuleImpl implements ZkModuleProver {
  ...
  public ProverModule(final AttributeSourceBuildingBlock parent, final String identifierOfModule, final String attributeId,
                      final BigInt value, final ResidueClass residueClass) {
  ...
  public void initializeModule(final ZkProofStateInitialize zkBuilder) {
    ...
    zkBuilder.setValueOfAttribute(attributeId, value, residueClass);
  }
