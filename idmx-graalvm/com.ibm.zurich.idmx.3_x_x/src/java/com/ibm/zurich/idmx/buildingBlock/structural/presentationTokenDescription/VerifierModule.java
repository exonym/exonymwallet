...
public class VerifierModule extends ZkModuleImpl implements ZkModuleVerifier {
  ...
  public VerifierModule(final PresentationTokenDescriptionBuildingBlock parent,
                        final String identifierOfModule, final SystemParameters systemParameters, final PresentationTokenDescription ptd) {
  ...
  public boolean verify(final ZkVerifierStateVerify zkVerifier) throws ConfigurationException,
      ProofException {
    zkVerifier.checkNValue(getIdentifier() + ":ptDescription:c14n",
