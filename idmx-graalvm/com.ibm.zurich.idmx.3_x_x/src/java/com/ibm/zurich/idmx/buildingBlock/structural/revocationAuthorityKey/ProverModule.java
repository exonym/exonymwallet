...
public class ProverModule extends ZkModuleImpl implements ZkModuleProver {
  ...
  public ProverModule(final RevocationAuthorityPublicKeyBuildingBlock parent, final String identifierOfModule,
  ...
  public void firstRound(final ZkProofStateFirstRound zkBuilder) throws ConfigurationException {
    zkBuilder.addNValue(getIdentifier() + ":raPk:c14n", pkWrapper.getHash(spWrapper.getHashFunction()));
  }
