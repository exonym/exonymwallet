...
public class InspectorSecretKeyWrapper extends SecretKeyWrapper {
  public InspectorSecretKeyWrapper(final PrivateKey secretKey) {
    super(secretKey);
  }

  @Override
  protected String createParameterUriBasedOnParameterName(final String parameterName) {
    return ParameterBaseName.inspectorPrivateKeyParameterName(parameterName);
