...
public class SystemParametersBuildingBlock extends GeneralBuildingBlock {

  public SystemParametersBuildingBlock() {
  ...
  public ZkModuleProver getZkModuleProver(final String identifierOfModule, final SystemParameters sp) {
    return new ProverModule(this, identifierOfModule, sp);
  }

  public ZkModuleVerifier getZkModuleVerifier(final String identifierOfModule, final SystemParameters sp) {
    return new VerifierModule(this, identifierOfModule, sp);
  }
