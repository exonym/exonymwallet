...
/**
 * @deprecated This test class is deprecated because the corresponding {@link DisjointSetImpl_old} is deprecated.
 */
@Deprecated
public class DisjointSetTest_old {

  @Test
  public void testFindNotNull() {
    DisjointSet<String> d = new DisjointSetImpl_old<String>();
    String a = "a";
  ...
  public void testMergeOfFourElements() {
    DisjointSet<String> x = new DisjointSetImpl_old<String>();
    String a = "a";
    String b = "b";
    String c = "c";
    String d = "d";
